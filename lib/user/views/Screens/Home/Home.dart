                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Task (" + _con.totaltask.toString() + ")",
                        style: TextStyle(
                            fontWeight: FontWeight.w500,
                            color: Colors.grey[700]),
                      ),
                    ), /////Taskk
                    _con.stffviewtask.length != 0 || _con.empdetails.length != 0
                        ? SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: _con.stffviewtask.length != null
                                    ? _con.stffviewtask.length
                                    : 0,
                                itemBuilder: (context, index) {
                                  ...
                                  final String fromedatee = frm.format(
                                      DateTime.parse(
                                          _con.stffviewtask[index]["from"]));
                                  final String todatee = frm.format(
                                      DateTime.parse(
                                          _con.stffviewtask[index]["to"]));
                                  return Container(
